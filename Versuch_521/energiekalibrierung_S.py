...
data0 = genfromtxt('Peak_channels/Co_S.txt',delimiter=';')
x0 = data0[:, 1]
y0 = data0[:, 3]
x0_error = data0[:, 2]
...
data1 = genfromtxt('Peak_channels/Cs_S.txt',delimiter=';')
x1 = data1[1]
y1 = data1[3]
x1_error = data1[2]
...
data2 = genfromtxt('Peak_channels/Eu_S.txt',delimiter=';')
x2 = data2[:, 1]
y2 = data2[:, 3]
x2_error = data2[:, 2]
...
# print('a='+str(round(popt[0],4))+';'+str(round(perr[0],4)))
# print('b='+str(round(popt[1],4))+';'+str(round(perr[1],4)))
...
plt.xlabel('Kanal(c)')
plt.legend()
plt.savefig("../pics/Energiekalibrierung_S.png")
# plt.show()
plt.cla()
plt.clf()
